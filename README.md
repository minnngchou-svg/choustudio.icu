...
封面比例按模块统一设置，不按单条内容单独设置。  
设置后，该模块在**首页和列表页**都会使用同一比例渲染封面，保证布局一致。

| 模块 | 默认比例 | 后台修改路径 |
|---|---|---|
| 设计作品 | 3:4 | 网站设置 → 导航与页面 → 设计作品 → 封面比例 |
| 开发作品 | 3:4 | 网站设置 → 导航与页面 → 开发作品 → 封面比例 |
| 文章 / 笔记 | 3:4 | 网站设置 → 导航与页面 → 文章 / 笔记 → 封面比例 |
| 视频教程 | 3:4 | 网站设置 → 导航与页面 → 视频教程 → 封面比例 |
